package com.compa.recognizesheet.views;
...
import com.compa.recognizesheet.AndroidCamera;
...
public class CameraPreview implements SurfaceHolder.Callback {
	...
	private List<Rect> createAreaSign(int width, int height) {
		...
		BOT = (int) ((botLeftY + halfBox) * ratioImg) - TOP;
		LEFT = (int) ((topLeftX + halfBox) * ratioImg) - RIGHT;

		// TL
		lstRect.add(new Rect(topLeftY - halfBox, topLeftX - halfBox, topLeftY + halfBox, topLeftX + halfBox));
